...
public protocol OperationStoringGameState: GameState {
    associatedtype GameAction: Equatable & Codable

    var operation: [EntityId: OperationComponent<GameAction>] { get set }
}

public typealias OperationCapableGameState = OperationStoringGameState & TransformProviding & SpriteProviding
